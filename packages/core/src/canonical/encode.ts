...
export type MapPolicy = 'error' | 'entries'; // encode as sorted array of [key, value]; key serialized as JSON string

export type SetPolicy = 'error' | 'array-sorted'; // encode as array of values sorted by their canonical JSON
